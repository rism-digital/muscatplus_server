...
def handle_person_source_request(req, person_id: str) -> Dict:
    ...
    request_compiler.filters += ["type:source_person_relationship", f"person_id:person_{person_id}"]
...
class PersonResults(BaseSearchResults):
    def get_items(self, obj: pysolr.Results) -> Optional[List]:
        ...
        return PersonRelationship(obj.docs, many=True, context={"request": self.context.get("request")}).data
