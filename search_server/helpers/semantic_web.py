# NB: Deprecated semantic web handling. The pyld module is not supported, and
# rdflib now supports json-ld so this should be re-written accordingly. This
# code left here for reference purposes only.
