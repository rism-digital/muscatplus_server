...
async def source(req, source_id: str):
    ...
    """
    return await handle_request(req, handle_source_request, source_id=source_id)


@sources_blueprint.route("/<source_id:str>/incipits/")
async def incipits_list(req, source_id: str):
    return await handle_request(req, handle_incipits_list_request, source_id=source_id)
...
async def contents(req, source_id: str):
    ...
    """
    return await handle_search(req, handle_contents_search_request, source_id=source_id)
...
async def probe(req, source_id: str):
    ...
    """
    return await handle_search(req, handle_contents_probe_request, source_id=source_id)
...
async def holdings(req, source_id: str):
    return await handle_request(
        req, handle_exemplar_section_request, source_id=source_id
    )
