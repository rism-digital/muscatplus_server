...
institutions_blueprint: Blueprint = Blueprint(
    "institutions", url_prefix="/institutions"
)
...
async def institution(req, institution_id: str):
    ...
    return await handle_request(
        req, handle_institution_request, institution_id=institution_id
    )
...
async def institution_sources(req, institution_id: str):
    ...
    return await handle_search(
        req, handle_institution_search_request, institution_id=institution_id
    )
...
async def institution_probe(req, institution_id: str):
    return await handle_search(
        req, handle_institution_probe_request, institution_id=institution_id
    )
