...
publications_blueprint: Blueprint = Blueprint(
    "publications", url_prefix="/publications"
)
...
async def publication(req, publication_id: str) -> response.HTTPResponse:
    return await handle_request(
        req, handle_publication_request, publication_id=publication_id
    )


@publications_blueprint.route("/")
async def publications_list(req) -> response.HTTPResponse:
    return await handle_request(req, handle_publication_list_request)
