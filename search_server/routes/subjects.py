...
from search_server.resources.subjects.subject_source import (
...
async def subject(req, subject_id: str):
    return await handle_request(req, handle_subject_request, subject_id=subject_id)


@subjects_blueprint.route("/<subject_id:str>/sources/")
async def subject_sources(req, subject_id: str):
    return await handle_search(
        req, handle_subject_source_request, subject_id=subject_id
    )
